...
sp_name_for_this_web <- name_file %>%
  ...
  map(~filter(.x, !duplicated(original_name))) %>%
  map(~deframe(.x))
...
taxa_df[[1]]$name_clear[3] <- "Sagitta gazellae"
taxa_df[[1]]$name_clear[4] <- "Sagitta gazellae"
taxa_df[[1]]$name_clear[7] <- "Bathylagus antarcticus"
taxa_df[[1]]$name_clear[8] <- "Electrona antarctica"
taxa_df[[1]]$name_clear[9] <- "Electrona antarctica"
taxa_df[[1]]$name_clear[10] <- "Electrona antarctica"
taxa_df[[1]]$name_clear[11] <- "Electrona antarctica"
taxa_df[[1]]$name_clear[12] <- "Gymnoscopelus braueri"
taxa_df[[1]]$name_clear[13] <- "Gymnoscopelus braueri"
