...
# 
# taxa_corrected <- taxa %>%
#   map(~mutate(.x, sp = str_replace_all(.x$sp, c("ciliates" = "Ciliophora", "small calanoids" = "Calanoida", "medium-sized calanoids " = "Calanoida",
#                                          "Cyclopoids" = "Cyclopoida", "juvenile euphausiids" = "Euphausiidae", "anchovy" = "Engraulidae"))))
# 
...
# 
# taxa_df[[1]]$name_clear[4] <- "Small phytoplankton"
# taxa_df[[1]]$name_clear[7] <- "Medium phytoplankton"
# taxa_df[[1]]$name_clear[9] <- "Meroplankton, appendicularians, doliolids"
