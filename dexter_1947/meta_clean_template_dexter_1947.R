...
ref <- list(doi       = "10.2307/1948658",
             ...
             year      = "1947",
             bibtex    = "@article{Dexter_1947, doi = {10.2307/1948658}, url = {https://doi.org/10.2307%2F1948658}, year = 1947, month = {feb}, publisher = {Wiley}, volume = {17}, number = {3}, pages = {261--294}, author = {Ralph W. Dexter}, title = {The Marine Communities of a Tidal Inlet at Cape Ann, Massachusetts: A Study in Bio-Ecology}, journal = {Ecological Monographs}}")
...
network <- list(`Shallow sublittoral` = list(name             = "Shallow_sublittoral_dexter_1947",
                                             date             = "1933-06-01",
                                             lat              = lat,
                                             lon              = lon,
                                             srid             = srid,
                        ...
                        `Rocky shore` = list(name             = "Rocky_shore_dexter_1947",
                                             date             = "1933-06-01",
                                             lat              = lat,
                                             lon              = lon,
                                             srid             = srid,
                                             ...
                                             public           = TRUE,
                                             all_interactions = FALSE),
                            `Mudflat` = list(name             = "Mudflat_dexter_1947",
                                             date             = "1933-06-01",
                                             lat              = lat,
                                             lon              = lon,
                                             srid             = srid,
                                             ...
                                             public           = TRUE,
                                             all_interactions = FALSE),
                     `Low salt marsh` = list(name             = "Low_salt_marsh_dexter_1947",
                                             date             = "1933-06-01",
                                             lat              = lat,
                                             lon              = lon,
                                             srid             = srid,
                                             ...
                                             public           = TRUE,
                                             all_interactions = FALSE),
                    `High salt marsh` = list(name             = "High_salt_marsh_dexter_1947",
                                             date             = "1933-06-01",
                                             lat              = lat,
                                             lon              = lon,
                                             srid             = srid,
...
inter <- list(`Shallow sublittoral` = list(taxon_1_level = "taxon",
                                           taxon_2_level = "taxon",
                                           date          = "1933-06-01",
                                           direction     = "directed",
                                           method        = "observation",
                                           ...
                                           lon           = lon,
                                           srid          = srid),
                      `Rocky shore` = list(taxon_1_level = "taxon",
                                           taxon_2_level = "taxon",
                                           date          = "1933-06-01",
                                           direction     = "directed",
                                           method        = "observation",
                                           ...
                                           lon           = lon,
                                           srid          = srid),
                          `Mudflat` = list(taxon_1_level = "taxon",
                                           taxon_2_level = "taxon",
                                           date          = "1933-06-01",
                                           direction     = "directed",
                                           method        = "observation",
                                           ...
                                           lon           = lon,
                                           srid          = srid),
                   `Low salt marsh` = list(taxon_1_level = "taxon",
                                           taxon_2_level = "taxon",
                                           date          = "1933-06-01",
                                           direction     = "directed",
                                           method        = "observation",
                                           ...
                                           lon           = lon,
                                           srid          = srid),
                  `High salt marsh` = list(taxon_1_level = "taxon",
                                           taxon_2_level = "taxon",
                                           date          = "1933-06-01",
                                           direction     = "directed",
                                           method        = "observation",
...
FW_name <- data_matrice %>% # Construct the Food Web matric to inject
  ...
  map(~mutate(.x, type = ifelse(str_detect(.x$sp_taxon_2, "(organic\\sdebris)"), "commensalism", .x$type))) %>%
...
taxa_taxize["fish fry"] <- "Pisces"
taxa_taxize["L. obtusata"] <- "Littorina obtusata"
taxa_taxize["L. saxatilis"] <- "Littorina saxatilis"
taxa_taxize["other algae"] <- "Algae"
