...
lat  <- -34.227648126510836
lon  <- 18.472200925093716
srid <- 4326
...
refs <- list(doi       = "NA",
            jstor     = "NA",
            pmid      = "NA",
            paper_url = "https://hdl.handle.net/10520/AJA00382353_1153",
            data_url  = "https://globalwebdb.com/",
            author    = "Brown",
            year      = "1964",
            bibtex    = "@article{brown1964food, title={Food relationships on the intertidal sandy beaches of the Cape Peninsula}, author={Brown, AC}, journal={South African Journal of Science}, volume={60}, number={2}, pages={35--41}, year={1964}, publisher={Academy of Science for South Africa (ASSAf)}}")
...
datasets <- list(name        = "Brown_1964",
                date        = "1957-01-01",
                description = "Food web structure of the intertidal sandy beaches communities, Cape Peninsula, South Africa",
                public      = TRUE)
...
name.of.web[19,1] <- "Curlew sandpiper"
name.of.web[21,1] <- "Sanderling"
name.of.web <- name.of.web[-c(20,22),]
...
matrice.interaction <- mutate(matrice.interaction, type = ifelse(sp_taxon_1 == 'Detritus' | sp_taxon_1 == "Organic macrodebris", 'commensalism', 'predation'))
