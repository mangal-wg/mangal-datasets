...
folder_name <- "gontikaki_2011" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB309")
...
ref <- list(doi       = "10.1016/j.pocean.2010.12.014",
             jstor     = "NA",
             pmid      = "NA",
             paper_url = "https://doi.org/10.1016%2Fj.pocean.2010.12.014",
             data_url  = "https://globalwebdb.com/",
             author    = "E. Gontikaki",
             year      = "2011",
             bibtex    = "@article{Gontikaki_2011, doi = {10.1016/j.pocean.2010.12.014}, url = {https://doi.org/10.1016%2Fj.pocean.2010.12.014}, year = 2011, month = {nov}, publisher = {Elsevier {BV}}, volume = {91}, number = {3}, pages = {245--259}, author = {E. Gontikaki and D. van Oevelen and K. Soetaert and U. Witte}, title = {Food web flows through a sub-arctic deep-sea benthic community}, journal = {Progress in Oceanography}}")
...
dataset <- list(name        = "gontikaki_2011",
                 date        = "2007-05-01",
                 description = "Food web of a sub-arctic deep-sea benthic community",
                 public      = TRUE)
...
network <- list(name        = "gontikaki_2011",
                 date        = "2007-05-01",
                 lat              = lat,
                 lon              = lon,
                 srid             = srid,
...
# 
# 
# taxa_df[[1]]$name_clear[2] <- "surface deposit-feeding polychaetes"
