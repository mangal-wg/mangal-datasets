...
refs <- list(doi       = "10.2307/2256021",
             jstor     = "https://www.jstor.org/stable/2256021",
             pmid      = "NA",
             paper_url = "https://www.jstor.org/stable/2256021?seq=1#metadata_info_tab_contents",
             data_url  = "http://digitalcommons.rockefeller.edu/context/cohen_joel_laboratory/article/1000/type/native/viewcontent",
             author    = "Richards",
             year      = "1926",
             bibtex    = "@article{Richards_1926,
	doi = {10.2307/2256021},
             ...
             publisher = {{JSTOR}},
             volume = {14},
             number = {2}, pages = {244}, author = {O. W. Richards}, title = {Studies on the Ecology of English Heaths: {III}. Animal Communities of the Felling and Burn Successions at Oxshott Heath, Surrey}, journal = {The Journal of Ecology}}")
...
datasets <- list(name        = "Richards_1926",
                 date        = "1922-01-01",
                 description = "Food web structure of an insect community on young pine, Oxshott Heath, England",
                 public      = TRUE)
...
networks <- list(name             = "Richards_1926",
                 date             = "1922-01-01",
                 lat              = lat,
                 lon              = lon,
                 srid             = srid,
...
library(reshape2)
library(tibble)
foldername <- 'Richards_1926'
food_web_name <- 'WEB151'
#Read the files
...
matrice.interaction <- mutate(matrice.interaction, type = ifelse(sp_taxon_1 == 'young Pinus sp.', 'herbivory', 'predation'))
matrice.interaction <- mutate(matrice.interaction, type = ifelse(sp_taxon_2 == 'ichneumonids (unspecified)', 'parasitism', type))
...
taxa_back_df[4,4] <- "1022404"
taxa_back_df[6,4] <- "114347"
taxa_back_df[15,4] <- "859725"
