...
lat  <- c("-60 00 00","-65 00 00", "-60 00 00")
lon  <- c("-50 00 00", "-70 00 00", "-50 00 00")
srid <- 4326

folder_name <- "cornejo-donoso_2008" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB266") # Name of the dataset in Trophic metacommunities-master/Trophic_metacom_meta_analysis/Data
...
ref <- list(doi       = "10.1016/j.ecolmodel.2008.06.011",
            jstor     = "NA",
            pmid      = "NA",
            paper_url = "https://doi.org/10.1016%2Fj.ecolmodel.2008.06.011",
            data_url  = "https://globalwebdb.com/",
            author    = "Jorge Cornejo-Donoso",
            year      = "2008",
            bibtex    = "@article{Cornejo_Donoso_2008, doi = {10.1016/j.ecolmodel.2008.06.011}, url = {https://doi.org/10.1016%2Fj.ecolmodel.2008.06.011}, year = 2008, month = {oct}, publisher = {Elsevier {BV}}, volume = {218}, number = {1-2}, pages = {1--17}, author = {Jorge Cornejo-Donoso and Tarsicio Antezana}, title = {Preliminary trophic model of the Antarctic Peninsula Ecosystem (Sub-area {CCAMLR} 48.1)}, journal = {Ecological Modelling}}")
...
dataset <- list(name        = "cornejo-donoso_2008",
                date        = "2008-01-01",
                description = "Food Web of the Antarctic Peninsula Ecosystem",
                public      = TRUE)
...
network <- list(name        = "cornejo-donoso_2008",
                date        = "2008-01-01",
                lat              = lat,
                lon              = lon,
                srid             = srid,
