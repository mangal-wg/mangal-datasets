...
lat  <- 41.651361520567356
lon  <- -80.41912390734831
srid <- 4326
...
datasets <- list(name        = "Cummins_et_al_1966",
                 date        = "1964-10-07",
                 description = "Food web structure of the small woodland stream Linesville Creek, Crawford County, North-western Pennsylvania, USA",
                 public      = TRUE)
...
networks <- list(name             = "Cummins_et_al_1966",
                 date             = "1964-10-07",
                 lat              = lat,
                 lon              = lon,
                 srid             = srid,
...
matrice.interaction <- mutate(matrice.interaction, type = ifelse(sp_taxon_1 == 'Diatoms', 'herbivory', type))
...
taxa_back_df[3,4] <- "100507"
taxa_back_df[19,4] <- "115028"
