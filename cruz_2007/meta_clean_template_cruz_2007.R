...
folder_name <- "cruz_2007" # Name of the subfolder in mangal-datasets
...
ref <- list(doi       = "10.1016/j.ecss.2006.10.013",
             jstor     = "NA",
             pmid      = "NA",
             paper_url = "https://doi.org/10.1016%2Fj.ecss.2006.10.013",
             data_url  = "https://globalwebdb.com/",
             author    = "V.H. Cruz-Escalona",
             year      = "2007",
             bibtex    = "@article{Cruz_Escalona_2007, doi = {10.1016/j.ecss.2006.10.013}, url = {https://doi.org/10.1016%2Fj.ecss.2006.10.013}, year = 2007, month = {mar}, publisher = {Elsevier {BV}}, volume = {72}, number = {1-2},pages = {155--167}, author = {V.H. Cruz-Escalona and F. Arregu{\'{\i}}n-S{\'{a}}nchez and M. Zetina-Rej{\'{o}}n}, title = {Analysis of the ecosystem structure of Laguna Alvarado, western Gulf of Mexico, by means of a mass balance model}, journal = {Estuarine, Coastal and Shelf Science}}")
...
dataset <- list(name        = "cruz_2007",
                 date        = "2007-01-01",
                 description = "Dietary matrix of the Laguna Alvarado",
                 public      = TRUE)
...
#   unname() %>%
#   unique() %>%
#   str_replace_all(c("Croakers" = "Sciaenidae", "Snappers" = "Lutjanidae", "Jacks" = "Carangidae", "Snooks" = "Centropomidae",
#                     "Catfish" = "Ariidae", "Flatfish" = "Pleuronectiformes", "Halfbeaks" = "Hemiramphidae", "Herrings" = "Clupeidae",
#                     "Mojarras" = "Gerreidae", "Mollies" = "Poecilidae", "Gobies" = "Gobiidae", "Mexican mojarras" = "Cichlidae",
#                     "Toadfish" = "Batrachoididae", "Pinfish" = "Sparidae", "Mullets" = "Mugilidae", "Needlefish" = "Belonidae",
#                     "Fat Sleepers" = "Eleotridae", "Swimming crabs" = "Portunidae", "Crayfish" = "Palaemonidae", "Shrimp" = "Penaeidae",
#                     "Polychaetes" = "Polychaeta" ,"Bivalves" = "Bivalvia", "Gastropods" = "Gastropoda", "Wigeongrass" = "Ruppia maritima"))
# 
...
# 
# taxa_df_global$name_clear[1] <- "Sea mammals"
# taxa_df_global$name_clear[2] <- "Rays"
# 
# taxa_df <- taxa %>%
