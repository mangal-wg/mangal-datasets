...
folder_name <- "mackintosh_1967" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB30") # Name of the dataset in Trophic metacommunities-master/Trophic_metacom_meta_analysis/Data
...
ref <- list(doi       = "NA",
            ...
            year      = "1967",
            bibtex    = "@incollection{mackintosh_1967, title = {A survey of antarctic biology up to 1945}, booktitle = {Biologie antarctique},  author = {N. A. Mackintosh}, editor = {R. Carrick, M. Holdgate, J. Prevost},  pages = {3-38}, year = {1967}, publisher = {(Hermann, Paris, 1964)}}")
...
dataset <- list(name        = "mackintosh_1967",
                date        = "01-01-1945",
                description = "DESCRIPTION",
                public      = TRUE)
...
network <- list(name        = "mackintosh_1967",
                date        = "01-01-1945",
                lat              = lat,
                lon              = lon,
                srid             = srid,
