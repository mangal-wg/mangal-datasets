...
refs <- list(doi       = "10.1079/9780851995250.0423",
             ...
             author    = "Silva",
             year      = "2002",
             bibtex    = "@article{article, author = {Silva, Wesley and De Marco Junior, Paulo and Hasui, Erica and Gomes, Veronica}, year = {2002}, month = {01}, pages = {}, title = {Patterns of Fruit-Frugivore Interactions in Two Atlantic Forest Bird Communities of South-eastern Brazil:Implications for Conservation}}")
...
# 
# # Open file
# Silva_De_Marco_Hasui_Gomes_2002 <- read.csv2(file = "raw/Silva_De_Marco_Hasui_Gomes_2002.csv", header = FALSE, sep = ",")
# 
# # Cleaning for melt()
# ## Get ROW one with Genus_species
# x  <- unname(unlist(Silva_De_Marco_Hasui_Gomes_2002[1, ]))
# x[1] <- 1
# colnames(Silva_De_Marco_Hasui_Gomes_2002) <- unlist(x)
# rm(x)
# 
# ## Delete unused row
# Silva_De_Marco_Hasui_Gomes_2002 <- Silva_De_Marco_Hasui_Gomes_2002[-1, ]
# 
# # Melt df
# Silva_De_Marco_Hasui_Gomes_2002 <- melt(Silva_De_Marco_Hasui_Gomes_2002, id.vars = c(1), na.rm = TRUE)
# 
# # Remove interaction value = 0 (no interaction)
# names(Silva_De_Marco_Hasui_Gomes_2002) <- c("sp_taxon_1", "sp_taxon_2", "value")
# Silva_De_Marco_Hasui_Gomes_2002 <- subset(Silva_De_Marco_Hasui_Gomes_2002, Silva_De_Marco_Hasui_Gomes_2002$value != 0)
# 
# #------------------------------
...
# traits_df <- read.csv2(file = "data/Silva_De_Marco_Hasui_Gomes_2002_traits.csv", header = TRUE)
