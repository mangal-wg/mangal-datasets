...
refs <- list(doi       = "10.1111/j.1365-2311.1985.tb00738.x",
            jstor     = "NA",
            pmid      = "NA",
            paper_url = "https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1365-2311.1985.tb00738.x",
            data_url  = "https://globalwebdb.com/",
            author    = "Hildrew",
            year      = "1985",
            bibtex    = "@article{HILDREW_1985,	doi = {10.1111/j.1365-2311.1985.tb00738.x}, url = {https://doi.org/10.1111%2Fj.1365-2311.1985.tb00738.x}, year = 1985, month = {nov}, publisher = {Wiley}, volume = {10}, number = {4}, pages = {403--413}, author = {ALAN G. HILDREW and COLIN R. TOWNSEND and AZIM HASHAM}, title = {The predatory Chironomidae of an iron-rich stream: feeding ecology and food web structure}, journal = {Ecological Entomology}}")
...
datasets <- list(name        = "Hildrew_et_al_1985",
                date        = "1974-04-01",
                description = "Food web structure of an iron-rich stream (Broadstone stream), England",
                public      = TRUE)
...
networks <- list(name             = "Hildrew_et_al_1985",
                date             = "1974-04-01",
                lat              = lat,
                lon              = lon,
                srid             = srid,
...
library(reshape2)
library(tibble)
foldername <- 'Hildrew_et_al_1985'
food_web_name <- 'WEB205'
#Read the files
...
name.of.web[16,2] <- "microinvertebrates"
...
matrice.interaction <- mutate(matrice.interaction, type = ifelse(sp_taxon_1 == 'fine particulate organic matter' | sp_taxon_1 == 'coarse particulate organic matter', 'commensalism', 'predation'))
