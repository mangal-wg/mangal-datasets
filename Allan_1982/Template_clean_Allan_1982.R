...
refs <- list(doi       = "10.2307/1938871",
            jstor     = "https://www.jstor.org/stable/1938871",
            pmid      = "NA",
            paper_url = "https://esajournals.onlinelibrary.wiley.com/doi/abs/10.2307/1938871",
            data_url  = "https://globalwebdb.com/",
            author    = "Allan",
            year      = "1982",
            bibtex    = "@article{Allan_1982,	doi = {10.2307/1938871}, url = {https://doi.org/10.2307%2F1938871}, year = 1982, month = {oct},	publisher = {Wiley}, volume = {63},	number = {5},	pages = {1444--1455},	author = {J. David Allan}, title = {The Effects of Reduction in Trout Density on the Invertebrate Community of a Mountain Stream}, journal = {Ecology}}")
...
datasets <- list(name        = "Allan_1982",
                date        = "1975-07-08",
                description = "Food web structure of a mountain stream, Cement Creek, Gunnison County, Colorado, USA",
                public      = TRUE)
...
library(reshape2)
library(tibble)
foldername <- 'Allan_1982'
food_web_name <- 'WEB202'
#Read the files
...
name.of.web[6,2] <- 'Ephemerella infrequens'
name.of.web[7,2] <- 'Alloperla'
name.of.web[8,2] <- 'Zapada haysi'
name.of.web[10,2] <- 'Simuliidae'
name.of.web[15,2] <- 'Invertebrata'
name.of.web[16,2] <- 'Homoptera'
name.of.web[17,2] <- 'Hymenoptera'
...
rm(lat, lon, srid, attr_inter, refs, users, enviro, datasets, traits, networks, inter, taxons_df, taxo_back_df, matrice.interaction)
