...
refs <- list(doi       = "10.1016/0304-3800(94)90038-8",
            jstor     = "NA",
            pmid      = "NA",
            paper_url = "https://www.sciencedirect.com/science/article/pii/0304380094900388",
            data_url  = "https://globalwebdb.com/",
            author    = "Gaedke",
            year      = "1994",
            bibtex    = "@article{Gaedke_1994, doi = {10.1016/0304-3800(94)90038-8}, url = {https://doi.org/10.1016%2F0304-3800%2894%2990038-8}, year = 1994, month = {sep}, publisher = {Elsevier {BV}}, volume = {75-76}, pages = {435--445}, author = {Ursula Gaedke and Dietmar Straile}, title = {Seasonal changes of trophic transfer efficiencies in a plankton food web derived from biomass size distributions and network analysis}, journal = {Ecological Modelling}}")
...
datasets <- list(name        = "Gaedke_Straile_1994",
                date        = "1987-03-23",
                description = "Food web structure of the mesoeutrophic Lake Constance, Central Europe",
                public      = TRUE)
...
networks <- list(name             = "Gaedke_Straile_1994",
                date             = "1987-03-23",
                lat              = lat,
                lon              = lon,
                srid             = srid,
...
library(reshape2)
library(tibble)
foldername <- 'Gaedke_Straile_1994'
food_web_name <- 'WEB294'
#Read the files
...
name.of.web[3,2] <- 'heterotrophic nanoflagellate'
...
rm(lat, lon, srid, attr_inter, refs, users, enviro, datasets, traits, networks, inter, taxons_df, taxo_back_df, matrice.interaction, foldername, food_web_name, i, path, server, taxa.clear, taxa.original, taxa_back_df, name.dictionary, name.of.web)
