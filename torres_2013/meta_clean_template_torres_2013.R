...
folder_name <- "torres_2013" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB338")
...
ref <- list(doi       = "10.1016/j.ecolmodel.2013.05.019",
             jstor     = "NA",
             pmid      = "NA",
             paper_url = "https://doi.org/10.1016%2Fj.ecolmodel.2013.05.019",
             data_url  = "https://globalwebdb.com/",
             author    = "Maria Angeles Torres",
             year      = "2013",
             bibtex    = "@article{Torres_2013, doi = {10.1016/j.ecolmodel.2013.05.019}, url = {https://doi.org/10.1016%2Fj.ecolmodel.2013.05.019}, year = 2013, month = {sep}, publisher = {Elsevier {BV}}, volume = {265}, pages = {26--44}, author = {Mar{\'{\i}}a {\'{A}}ngeles Torres and Marta Coll and Johanna Jacomina Heymans and Villy Christensen and Ignacio Sobrino}, title = {Food-web structure of and fishing impacts on the Gulf of Cadiz ecosystem (South-western Spain)}, journal = {Ecological Modelling}}")
...
dataset <- list(name        = "torres_2013",
                 date        = "2013-01-01",
                 description = "Food web of the the Gulf of Cadiz",
                 public      = TRUE)
...
#   map(~mutate(.x, sp = str_replace_all(.x$sp, c("Mackerels" = "Scomber", "Horse mackerels" = "Trachurus", "Benthic cephalopods" = "Cephalopoda",
#                     "Anchovy" = "Engraulis encrasicolus", "Sardine" = "Sardina pilchardus", "Benthopelagic cephalopods" = "Cephalopoda",
#                     "Shrimps" = "Decapoda", "Common octopus" = "Octopus vulgaris", "Blue whiting" = "Micromesistius poutassou", 
#                     "Rose shrimp" = "Parapenaeus longirostris", "Mantis shrimp" = "Squilla mantis", "Crabs" = "Brachyura",
#                     "Sharks" = "Selachii", "Polychaetes" = "Polychaeta", "Norway lobster" = "Nephrops norvegicus", "Bivalves" = "Bivalvia",
#                     "Mullets" = "Mullus", "Killer whales" = "Orcinus orca", "Dolphins" = "Delphinidae", "Loggerhead turtles" = "Caretta caretta",
#                     "Anglerfishes" = "Lophius", "Skates" = "Rajiformes"))))
# 
...
# 
# 
# taxa_df[[1]]$name_clear[8] <- "Adult hake"
# taxa_df[[1]]$name_clear[11] <- "Small benthopelagic fishes"
# taxa_df[[1]]$name_clear[13] <- "Small demersal fishes"
# taxa_df[[1]]$name_clear[21] <- "Demersal piscivores"
# taxa_df[[1]]$name_clear[22] <- "Large benthopelagic fishes"
# taxa_df[[1]]$name_clear[23] <- "Demersal fishes"
