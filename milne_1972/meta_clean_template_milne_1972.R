...
folder_name <- "milne_1972" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB55", "WEB56") # Name of the dataset in Trophic metacommunities-master/Trophic_metacom_meta_analysis/Data
...
ref <- list(doi       = "NA",
            ...
            author    = "H. Milne",
            year      = "1972",
            bibtex    = "@incollection{milne_1972, title = {Standing crop, productivity and trophic relations of the fauna of the Ythan estuary}, booktitle = {The Estuarine Environment}, author = {H. Milne, G. M. Dunnet}, editor = {R. S. K. Barnes, J.  Green}, pages = {86-106, from p. 88}, year = {1972}, publisher = {(Applied Science Publications, Edinburgh, Scotland, 1972)}}")
...
network <- list(Mudflat = list(name             = "mudflat_milne_1972",
                               date             = "1972-01-01",
                               lat              = lat,
                               lon              = lon,
                               srid             = srid,
                               description      = "Food web of Mudflat",
                               public           = TRUE,
                               all_interactions = FALSE),
                Mussel = list(name             = "mussel_milne_1972",
                              date             = "1972-01-01",
                              lat              = lat,
                              lon              = lon,
                              srid             = srid,
                              description      = "Food web of Mussel banc",
                              public           = TRUE,
                              all_interactions = FALSE))
...
taxa_df[[1]]$name_clear[11] <- "Tringa"
taxa_df[[1]]$name_clear[12] <- "Calidris alpina"
taxa_df[[1]]$name_clear[13] <- "Calidris canutus"
taxa_df[[1]]$name_clear[15] <- "Phalacrocoracidae"
taxa_df[[1]]$name_clear[16] <- "Ardeidae"
