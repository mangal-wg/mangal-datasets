...
folder_name <- "knox_1970" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB20") # Name of the dataset in Trophic metacommunities-master/Trophic_metacom_meta_analysis/Data
...
ref <- list(doi       = "NA",
            ...
            author    = "G. A. Knox",
            year      = "1970",
            bibtex    = "@incollection{knox_1970, title = {Antarctic marine ecosystems}, booktitle = {Antarctic Ecology},  author = {G. A. Knox}, editor = {M. W. Holdgate},  pages = {69-96, from p. 87}, year = {1970}, publisher = {(Academic Press, New York, 1970)}}")
...
dataset <- list(name        = "knox_1970",
                date        = "1970-01-01",
                description = "Food web of Antarctic marine ecosystems",
                public      = TRUE)
...
taxa_df[[1]]$name_clear[7] <- "Euphasia crystallorophias"
