...
refs <- list(doi       = "10.1016/j.ecolmodel.2009.05.020",
            jstor     = "NA",
            pmid      = "NA",
            paper_url = "https://www.sciencedirect.com/science/article/pii/S0304380009003822",
            data_url  = "https://globalwebdb.com/",
            author    = "Feroz Khan",
            year      = "2009",
            bibtex    = "@article{Feroz_Khan_2009, doi = {10.1016/j.ecolmodel.2009.05.020}, url = {https://doi.org/10.1016%2Fj.ecolmodel.2009.05.020}, year = 2009, month = {sep}, publisher = {Elsevier {BV}}, volume = {220}, number = {18}, pages = {2281--2290}, author = {M. Feroz Khan and Preetha Panikkar}, title = {Assessment of impacts of invasive fishes on the food web structure and ecosystem properties of a tropical reservoir in India}, journal = {Ecological Modelling}}")
...
datasets <- list(name        = "FerozKhan_Panikkar_2009",
                #date        = "1111-11-11",
                description = "Food web structure and diet composition based on an Ecopath model of Kelavarapalli reservoir in Hosur Taluk, Tamil Nadu state, India",
                public      = TRUE)
...
networks <- list(name             = "FerozKhan_Panikkar_2009",
                #date             = "1111-11-11",
                lat              = lat,
                lon              = lon,
                srid             = srid,
...
library(reshape2)
library(tibble)
foldername <- 'FerozKhan_Panikkar_2009'
food_web_name <- 'WEB310'
#Read the files
...
matrice.interaction <- mutate(matrice.interaction, type = ifelse(sp_taxon_1 == 'Macrophytes' | sp_taxon_1 == 'Phytoplankton', 'herbivory', 'predation'))
