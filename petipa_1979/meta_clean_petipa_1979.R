...
taxa_df[[1]]$name_clear[3] <- "Phytoplankton"
taxa_df[[1]]$name_clear[4] <- "Phytoplankton"
taxa_df[[1]]$name_clear[18] <- "Euchaeta"
taxa_df[[1]]$name_clear[19] <- "Centropages"
taxa_df[[1]]$name_clear[20] <- "Amphipoda"
taxa_df[[1]]$name_clear[21] <- "Euphausia"
