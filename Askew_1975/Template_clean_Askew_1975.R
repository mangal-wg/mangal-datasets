...
lat  <- 51.775986501172795
lon  <- -1.3344262809448537
srid <- 4326
...
refs <- list(doi       = "10.1007/978-1-4615-8732-3_7",
             jstor     = "NA",
             pmid      = "NA",
             paper_url = "https://link.springer.com/chapter/10.1007/978-1-4615-8732-3_7",
             data_url  = "http://digitalcommons.rockefeller.edu/context/cohen_joel_laboratory/article/1000/type/native/viewcontent",
             author    = "Askew",
             year      = "1975",
             bibtex    = "@incollection{Askew_1975,	doi = {10.1007/978-1-4615-8732-3_7}, url = {https://doi.org/10.1007%2F978-1-4615-8732-3_7}, year = 1975, publisher = {Springer {US}}, pages = {130--153}, author = {R. R. Askew}, title = {The Organisation of Chalcid-Dominated Parasitoid Communities Centred upon Endophytic Hosts}, booktitle = {Evolutionary Strategies of Parasitic Insects and Mites}}")
...
datasets <- list(name        = "Askew_1975",
                 #date        = "1111-11-11",
                 description = "Food web structure of a chalcid-dominated parasitoid community on Oak galls of A. curvator, Wytham Wood, United Kingdom",
                 public      = TRUE)
...
library(reshape2)
library(tibble)
foldername <- 'Askew_1975'
food_web_name <- 'WEB155'
#Read the files
...
matrice.interaction[['type']] <- "parasitism"
matrice.interaction <- mutate(matrice.interaction, type = ifelse(sp_taxon_2 == 'Synergus nervosus' | sp_taxon_2 == "S. gallae-pomiformis", 'herbivory', type))
matrice.interaction <- mutate(matrice.interaction, type = ifelse((sp_taxon_1 == 'gall tissue (Q. robur)' & sp_taxon_2 == "Eurytoma brunniventris"), 'herbivory', type))
