...
lat  <- conv_unit(c("42 17 37", "42 20 35", "42 19 12", "42 19 26", "42 19 29", "42 17 37"), "deg_min_sec", "dec_deg") # Lat in XX°XX'XX3
lon  <- conv_unit(c("-08 38 43", "-08 34 21", "-08 36 59", "-08 36 59", "-08 36 57", "-08 38 43"), "deg_min_sec", "dec_deg") # Lon in XX°XX'XX3
srid <- 4326
...
ref <- list(doi       = "10.1016/j.csr.2010.10.010",
             ...
             author    = "R. Filgueira",
             year      = "2011",
             bibtex    = "@article{Filgueira_2011, doi = {10.1016/j.csr.2010.10.010}, url = {https://doi.org/10.1016%2Fj.csr.2010.10.010}, year = 2011, month = {apr}, publisher = {Elsevier {BV}}, volume = {31}, number = {5}, pages = {476--487}, author = {R. Filgueira and B.G. Castro}, title = {Study of the trophic web of San Simón Bay (Ría de Vigo) by using stable isotopes}, journal = {Continental Shelf Research}}")
...
## Network
POST_network(network, dataset = dataset, users = users, enviro = NULL)
...
## Interaction
map(FW_name, ~POST_interaction(inter_df = .x, inter = inter, attr = attr_inter, users = users, network = network))
