...
folder_name <- "shushkina_1979" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB102") # Name of the dataset in Trophic metacommunities-master/Trophic_metacom_meta_analysis/Data
...
ref <- list(doi       = "NA",
            ...
            author    = "E. A. Shushkina",
            year      = "1979",
            bibtex    = "@incollection{shushkina_1979, title = {Trophic relationships in communities and the functioning of marine ecosystems: Some results of investigations on the pelagic ecosystem in tropical regions of the ocean}, booktitle = {Marine Production Mechanisms}, chapter = {II}, author = {E. A. Shushkina, M. E. Vinogradov}, editor = {M. J. Dunbar}, pages = {251-268, from p. 260}, year = {1979}, publisher = {(International Biological Programme Series, no. 20, Cambridge Univ. Press)}}")
...
dataset <- list(name        = "shushkina_1979",
                date        = "1979-01-01",
                description = "Food web of tropical pelagic ecosystem",
                public      = TRUE)
...
network <- list(name        = "shushkina_1979",
                date        = "1979-01-01",
                lat              = lat,
                lon              = lon,
                srid             = srid,
...
taxa_df[[1]]$name_clear[4] <- "Euphausiacea"
taxa_df[[1]]$name_clear[8] <- "Euphausiacea"
