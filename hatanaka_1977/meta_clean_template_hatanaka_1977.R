...
folder_name <- "hatanaka_1977" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB81") # Name of the dataset in Trophic metacommunities-master/Trophic_metacom_meta_analysis/Data
...
ref <- list(doi       = "NA",
            ...
            author    = "M. A. Hatanaka",
            year      = "1977",
            bibtex    = "@techreport{hatanaka_1977, title = {Productivity of Biocenoses in Coastal Regions}, author = {M. A. Hatanaka}, Institution = {Japanese Committee for the International Biological Program Synthesis}, pages = {from p. 190}, year = {1977}}")
...
dataset <- list(name        = "hatanaka_1977",
                date        = "01-01-1977",
                description = "Food web of Sendai Bay",
                public      = TRUE)
...
network <- list(name        = "hatanaka_1977",
                date        = "01-01-1977",
                lat              = lat,
                lon              = lon,
                srid             = srid,
