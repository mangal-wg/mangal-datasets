...
folder_name <- "christian_1999" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB288")
...
ref <- list(doi       = "10.1016/s0304-3800(99)00022-8",
             jstor     = "NA",
             pmid      = "NA",
             paper_url = "https://doi.org/10.1016%2Fs0304-3800%2899%2900022-8",
             data_url  = "https://globalwebdb.com/",
             author    = "Robert R. Christian",
             year      = "1999",
             bibtex    = "@article{Christian_1999, doi = {10.1016/s0304-3800(99)00022-8}, url = {https://doi.org/10.1016%2Fs0304-3800%2899%2900022-8},year = 1999,month = {apr},publisher = {Elsevier {BV}},volume = {117},number = {1},pages = {99--124},author = {Robert R. Christian and Joseph J. Luczkovich},title = {Organizing and understanding a winter's seagrass foodweb network through effective trophic levels},journal = {Ecological Modelling}}")
...
dataset <- list(name        = "christian_1999",
                 date        = "1994-01-01",
                 description = "Food web of a winter’s seagrass",
                 public      = TRUE)
...
network <- list(name        = "christian_1999",
                 date        = "1994-01-01",
                 lat              = lat,
                 lon              = lon,
                 srid             = srid,
...
FW_name <- data_matrice %>%
  ...
  map(~mutate(.x, type = ifelse(str_detect(.x$sp_taxon_1, "(.*[Pp]lant.*)|(.*[Aa]lgae.*)|(.*[Pp]hyto.*)|(.*[Dd]iatoms.*)|(.*[Dd]inofl.*)|(.*[Ss]ilicoflag.*)|
                                                         ...
                                                         (Macro-epiphytes)"), "herbivory", "predation"))) %>% # Add type interaction
...
# 
# sp_name <- taxa %>%
#   map(~mutate(.x, sp = str_replace_all(.x$sp, c("Epiphyte-grazing amphipods" = "Amphipoda", "Suspension-feeding molluscs" = "Mollusca", "Hermit crabs" = "Pagurus",
#                                                    "Deposit-feeding peracaridan crustaceans" = "Crustacea", "Deposit-feeding gastropods" = "Gastropoda",
#                                                    "Deposit-feeding polychaetes" = "Polychaeta", "Predatory polychaetes" = "Polychaeta", "Omnivorous crabs" = "Brachyura",
#                                                    "Herbivorous shrimps" = "Alpheoidea", "Predatory shrimps" = "Decapoda", "Southern hake and sea robins" = "Acanthomorphata",
#                                                    "Pipefish and seahorses" = "Syngnathidae", "Suspension-feeding polychaetes" = "Polychaeta", "Spot" = "Leiostomus xanthurus",
#                                                    "Pinfish" = "Lagodon rhomboides", "Isopods" = "Isopoda", "Brittle stars" = "Ophioderma brevispinum", "Other gastropods" = "Gastropoda",
#                                                    "Sheepshead minnow" = "Cyprinodon variegatus", "Killifishes" = "Fundulidae", "Other gastropods" = "Gastropoda",
#                                                    "Epiphyte-grazing gastropods" = "Gastropoda", "Flounder and needlefish" = "Percomorphaceae", 
#                                                    "Atlantic silverside and bay anchovies" = "Clupeocephala", "Gobies and blennies" = "Gobiinae", "Blue crabs" = "Callinectes sapidus",
#                                                    "Red drum" = "Sciaenops ocellatus", "Spider crabs (herbivores)" = "Libinia dubia", "Tonguefish" = "Symphurus plagisua",
#                                                    "Predatory gastropods" = "Gastropoda", "Benthos eating birds" = "Aves", "Fish-eating birds" = "Aves", 
#                                                    "Fish and crustacean-eating birds" = "Aves", "Gulls" = "Larus", "Raptors" = "Accipitrinae", "Herbivorous ducks" = "Anas discors"))))
# 
