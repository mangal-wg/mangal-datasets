...
datasets <- list(name        = "Hurlbert_et_al_1972",
                date        = "1968-05-20",
                description = "Food web structure of experimental fresh-water ponds, Bakersfield, California",
                public      = TRUE)
...
networks <- list(name             = "Hurlbert_et_al_1972",
                date             = "1968-05-20",
                lat              = lat,
                lon              = lon,
                srid             = srid,
...
library(reshape2)
library(tibble)
foldername <- 'Hurlbert_et_al_1972'
food_web_name <- 'WEB116'
#Read the files
...
name.of.web <- name.of.web[-c(8),]
name.of.web[7,1] <- "Cyclops (copepod)"
name.of.web[5,2] <- "Moina micrura"
name.of.web[6,2] <- "Diaptomus pallidus"
name.of.web[8,2] <- "Asplanchna brightwelli"
