...
refs <- list(doi       = "10.2307/1935046",
            jstor     = "https://www.jstor.org/stable/1935046",
            pmid      = "NA",
            paper_url = "https://www.jstor.org/stable/pdf/1935046.pdf?refreqid=excelsior%3A5ee467fc260fece70b0e56042958c64a",
            data_url  = "https://globalwebdb.com/",
            author    = "Collins",
            year      = "1976",
            bibtex    = "@article{Collins_1976, doi = {10.2307/1935046}, url = {https://doi.org/10.2307%2F1935046}, year = 1976, month = {nov}, publisher = {Wiley}, volume = {57}, number = {6}, pages = {1221--1232}, author = {Nicholas C. Collins and Rodger Mitchell and Richard G. Wiegert}, title = {Functional Analysis of a Thermal Spring Ecosystem, with an Evaluation of the Role of Consumers}, journal = {Ecology}}")
...
datasets <- list(name        = "Collins_et_al_1976",
                date        = "1972-07-11",
                description = "Community interaction of a alkalin thermal spring ecosystem, Yellowstone National Park, Wyoming, USA",
                public      = TRUE)
...
networks <- list(name             = "Collins_et_al_1976",
                date             = "1972-07-11",
                lat              = lat,
                lon              = lon,
                srid             = srid,
...
inter <- list(date          = "1972-07-11",
              direction     = "directed",
              method        = "Field observation and laboratory experiments",
              description   = "null",
              public        = TRUE,
              lat           = lat,
              lon           = lon,
...
library(reshape2)
library(tibble)
foldername <- 'Collins_et_al_1976'
food_web_name <- 'WEB203'
#Read the files
...
matrice.interaction <- mutate(matrice.interaction, type = ifelse(str_detect(matrice.interaction$sp_taxon_1, 'blue-green algal-bacterial mat'), 'herbivory', 'predation'))
matrice.interaction[2,4] <- "parasitism"
