...
refs <- list(doi       = "10.2307/1697",
            jstor     = "https://www.jstor.org/stable/1697",
            pmid      = "NA",
            paper_url = "https://www.jstor.org/stable/pdf/1697.pdf?refreqid=excelsior%3A43d0b96cf825c21745dd25c9e82d9777",
            data_url  = "http://digitalcommons.rockefeller.edu/context/cohen_joel_laboratory/article/1000/type/native/viewcontent",
            author    = "Robinson",
            year      = "1953",
            bibtex    = "@article{Robinson_1953, doi = {10.2307/1697}, url = {https://doi.org/10.2307%2F1697}, year = 1953, month = {may}, publisher = {{JSTOR}}, volume = {22}, number = {1}, pages = {149}, author = {I. Robinson}, title = {On the Fauna of a Brown Flux of an Elm Tree, Ulmus procera Salisb.}, journal = {The Journal of Animal Ecology}}")
...
datasets <- list(name        = "Robinson_1953",
                date        = "1948-01-01",
                description = "The insect community of an elm tree brown flux (Ulmus procera salisb), Sheffield",
                public      = TRUE)
...
networks <- list(name             = "Robinson_1953",
                date             = "1948-01-01",
                lat              = lat,
                lon              = lon,
                srid             = srid,
...
library(reshape2)
library(tibble)
foldername <- 'Robinson_1953'
food_web_name <- 'WEB179'
#Read the files
...
matrice.interaction <- mutate(matrice.interaction, type = ifelse(str_detect(matrice.interaction$sp_taxon_1, 'flux material'), 'herbivory','predation'))
...
taxons_df[7,2] <- "Ulmus procera salisb"
#Taxa_back
