...
folder_name <- "kemp_1977" # Name of the subfolder in mangal-datasets
food_web_name <- "WEB70"
...
ref <- list(doi       = "NA",
             ...
             author    = "W. M. Kemp",
             year      = "1977",
             bibtex    = "@inbook{kemp_1977, place={New York}, title={Energy cost-benefit analysis applied to power plants near Crystal River, Florida}, booktitle={Ecosystem Modeling in Theory and Practice: An Introduction with Case Histories}, publisher={Wiley}, author={Kemp, W. M. and Smith, W. H. B. and McKellar, H. N. and Lehman, M. E. and Homer, M. and Young, D. L. and Odum, H. T.}, pages={507–543, p. 512}}")
...
#   map(~mutate(.x, sp = str_replace_all(.x$sp, c("mullet" = "Mugilidae", "blue crabs" = "Callinectes sapidus", "black drum" = "Pogonias cromis","red drum" = "Sciaenops ocellatus"))))
# 
...
# 
# taxa_df[[1]]$`name_clear`[6] <- "Small fish" # Manually editing some wrong name added by Global Names Recognition and Discovery.
# taxa_df[[1]]$`name_clear`[8] <- "Rays"
