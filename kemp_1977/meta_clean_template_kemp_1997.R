...
taxa_df[[1]]$name_clear[3] <- "Mugilidae"
taxa_df[[1]]$name_clear[6] <- "Brachyura"
taxa_df[[1]]$name_clear[7] <- "Batoidea"
taxa_df[[1]]$name_clear[8] <- "Pogonias cromis"
taxa_df[[1]]$name_clear[10] <- "Salmoninae"
taxa_df[[1]]$name_clear[12] <- "Sciaenops ocellatus"
