...
lat  <- 64.05251563688483
lon  <- 23.660406719118896
srid <- 4326
...
refs <- list(doi       = "NA",
             jstor     = "NA",
             pmid      = "NA",
             paper_url = "http://www.ephemeroptera-galactica.com/pubs/pub_k/pubkuuselak1979p1.pdf",
             data_url  = "https://globalwebdb.com/",
             author    = "Kuusela",
             year      = "1979",
             bibtex    = "@article{kuusela1979early, title={Early summer ecology and community structure of the macrozoobenthos on stones}, author={Kuusela, Kalevi}, journal={Acta Univer. Ouluensis Ser. A Sci. Rerum Nat}, volume={87}, pages={1--130}, year={1979}}")
...
datasets <- list(name        = "Kuusela_1979",
                 date        = "1965-06-01",
                 description = "Food web structure of macrozoobenthos under stones at Javajankoski rapids, Lestijoki river, Finland",
                 public      = TRUE)
...
networks <- list(name             = "Kuusela_1979",
                 date             = "1965-06-01",
                 lat              = lat,
                 lon              = lon,
                 srid             = srid,
...
name.of.web[3,2] <- "Diatoms"
name.of.web[13,2] <- "cricotopus triannulatus"
name.of.web <- name.of.web[-c(14),]
...
matrice.interaction <- mutate(matrice.interaction, sp_taxon_1 = ifelse(sp_taxon_1 == "Cricotopus", "Cricotopus triannulanus", sp_taxon_1))
matrice.interaction <- mutate(matrice.interaction, sp_taxon_2 = ifelse(sp_taxon_2 == "Cricotopus", "Cricotopus triannulanus", sp_taxon_2))
matrice.interaction <- subset(matrice.interaction, !(matrice.interaction$sp_taxon_1=="Triannulatus"|matrice.interaction$sp_taxon_2=="Triannulatus"))
...
matrice.interaction <- mutate(matrice.interaction, type = ifelse(sp_taxon_1 == 'Filamentous algae' | sp_taxon_1 == "Diatoms" | 
                                                                 sp_taxon_1 == "Mosses", 'herbivory', type))
...
taxons_df[c(13,16),2] <- c("Cricotopus triannulatus","Cricotopus bicinctus")
#Taxa_back
