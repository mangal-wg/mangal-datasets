...
refs <- list(doi       = "10.2307/2255796",
            jstor     = "http://www.jstor.org/stable/2255796",
            pmid      = "NA",
            paper_url = "https://www.jstor.org/stable/pdf/2255796.pdf?refreqid=excelsior%3Ae1673e1fda8e6eb7adac5094a6117b73",
            data_url  = "http://digitalcommons.rockefeller.edu/context/cohen_joel_laboratory/article/1000/type/native/viewcontent",
            author    = "Summerhayes",
            year      = "1928",
            bibtex    = "@article{Summerhayes_1928,	doi = {10.2307/2255796}, url = {https://doi.org/10.2307%2F2255796}, year = 1928, month = {aug}, publisher = {{JSTOR}}, volume = {16}, number = {2}, pages = {201}, author = {V. S. Summerhayes}, title = {North-East Land and Hinlopen Strait}, journal = {The Journal of Ecology}}")
...
datasets <- list(name        = "Summerhayes_1928",
                #date        = "1111-11-11",
                description = "Food web structure of the barren regions of North-East Land and Hinlopen Strait",
                public      = TRUE)
...
networks <- list(name             = "Summerhayes_1928",
                #date             = "1111-11-11",
                lat              = lat,
                lon              = lon,
                srid             = srid,
...
name.of.web[4,1] <- "landflies"
name.of.web[4,2] <- "diptera"
name.of.web[14,1] <- "purple sandpiper"
...
matrice.interaction <- mutate(matrice.interaction, type = ifelse(sp_taxon_1 == 'lichens'| sp_taxon_1 == 'mosses', 'herbivory', 'predation'))
...
taxa_back_df[2,4] <- "14189"
taxa_back_df[8,4] <- "176646"
#------------------------------
# Set traits table
#------------------------------
