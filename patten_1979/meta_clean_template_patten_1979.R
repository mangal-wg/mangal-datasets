...
folder_name <- "patten_1979" # Name of the subfolder in mangal-datasets
food_web_name <- "WEB21"
...
ref <- list(doi       = "10.1016/b978-0-12-318750-5.50014-3",
             jstor     = "NA",
             pmid      = "NA",
             paper_url = "https://doi.org/10.1016%2Fb978-0-12-318750-5.50014-3",
             data_url  = "https://globalwebdb.com/",
             author    = "Bernard C. Patten",
             year      = "1979",
             bibtex    = "@incollection{Patten_1979, doi = {10.1016/b978-0-12-318750-5.50014-3}, url = {https://doi.org/10.1016%2Fb978-0-12-318750-5.50014-3}, year = 1979, publisher = {Elsevier}, pages = {183--212}, author = {Bernard C. Patten and John T. Finn}, title = {{SYSTEMS} {APPROACH} {TO} {CONTINENTAL} {SHELF} {ECOSYSTEMS}}, booktitle = {Theoretical Systems Ecology}}")
...
dataset <- list(name        = "patten_1979",
                 date        = "1979-01-01",
                 description = "Food web of Ross Sea pelagic ecosystem",
                 public      = TRUE)
...
#   map(~mutate(.x, sp = str_replace_all(.x$sp, c("cephalopods" = "Cephalopoda", "penguins" = "Spheniscidae", 
#                                                 "seals" = "Pinnipedia"))))
# 
