...
folder_name <- "qazim_1970" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB1") # Name of the dataset in Trophic metacommunities-master/Trophic_metacom_meta_analysis/Data
...
ref <- list(doi       = "NA",
            ...
            author    = "S. Z. Qazim",
            year      = "1970",
            bibtex    = "@incollection{qazim_1970, title = {Some problems related to the food chain in a tropical estuary}, booktitle = {Marine Food Chains},  author = {S. Z. Qazim}, editor = {J. H. Steele}, pages = {45-51, from p. 50}, year = {1970}, publisher = {(Oliver and Boyd, Edinburgh, 1970)}}")
...
dataset <- list(name        = "qazim_1970",
                date        = "01-01-1970",
                description = "Food web of Cohin backwater",
                public      = TRUE)
