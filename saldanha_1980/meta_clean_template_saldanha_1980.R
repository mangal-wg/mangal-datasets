...
folder_name <- "saldanha_1980" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB69") # Name of the dataset in Trophic metacommunities-master/Trophic_metacom_meta_analysis/Data
...
ref <- list(doi       = "NA",
            ...
            author    = "L. Saldanha",
            year      = "1980",
            bibtex    = "@article{saldanha_1980, title = {Estudio Ambiental do Estuario do Tejo}, author = {L. Saldanha}, year = {1980}, publisher = {(CNA/Tejo, Lisbon, 1980)}}")
...
dataset <- list(name        = "saldanha_1980",
                date        = "01-01-1980",
                description = "Food web of the Tage estuary",
                public      = TRUE)
...
network <- list(name        = "saldanha_1980",
                date        = "01-01-1980",
                lat              = lat,
                lon              = lon,
                srid             = srid,
