...
network <- list(`Sea otter dominated` = list(name             = "Sea_otter_dominateds_imenstad_1978",
                                             date             = "1969-01-01",
                                             lat              = lat,
                                             lon              = lon,
                                             srid             = srid,
                ...
                `Sea urchin dominated` = list(name             = "Sea_urchin_dominated_simenstad_1978",
                                              date             = "1969-01-01",
                                              lat              = lat,
                                              lon              = lon,
                                              srid             = srid,
...
inter <- list(`Sea otter dominated` = list(taxon_1_level = "taxon",
                                           taxon_2_level = "taxon",
                                           date          = "1969-01-01",
                                           direction     = "directed",
                                           method        = "observation",
                                           ...
                                           lon           = lon,
                                           srid          = srid),
              `Sea urchin dominated` = list(taxon_1_level = "taxon",
                                           taxon_2_level = "taxon",
                                           date          = "1969-01-01",
                                           direction     = "directed",
                                           method        = "observation",
...
FW_name <- sep_pooled_many(FW_name, "(\\s-\\s)")
...
taxa_df[[1]]$name_clear[2] <- "Polyplacophora"
taxa_df[[1]]$name_clear[3] <- "Gastropoda"
taxa_df[[1]]$name_clear[4] <- "Patellogastropoda"
taxa_df[[1]]$name_clear[13] <- "Phytoplankton"

taxa_df[[2]]$name_clear[2] <- "Polyplacophora"
taxa_df[[2]]$name_clear[3] <- "Gastropoda"
taxa_df[[2]]$name_clear[4] <- "Patellogastropoda"
taxa_df[[2]]$name_clear[12] <- "Phytoplankton"
