...
refs <- list(doi       = "10.2307/1933577",
            jstor     = "https://www.jstor.org/stable/1933577",
            pmid      = "NA",
            paper_url = "https://esajournals.onlinelibrary.wiley.com/doi/abs/10.2307/1933577",
            data_url  = "https://globalwebdb.com/",
            author    = "Carlson",
            year      = "1968",
            bibtex    = "@article{Carlson_1968,	doi = {10.2307/1933577},	url = {https://doi.org/10.2307%2F1933577},	year = 1968,	month = {jan},	publisher = {Wiley},	volume = {49},	number = {1},	pages = {162--169},	author = {Clarence A. Carlson},	title = {Summer Bottom Fauna of the Mississippi River, above Dam 19, Keokuk, Iowa},	journal = {Ecology}}")
...
datasets <- list(name        = "Carlson_1968",
                date        = "1960-06-14",
                description = "Food web structure of the biological community in the Mississippi River above Dam 19, Keokuk, Iowa",
                public      = TRUE)
...
networks <- list(name             = "Carlson_1968",
                date             = "1960-06-14",
                lat              = lat,
                lon              = lon,
                srid             = srid,
...
#name.of.web <- name.of.web[-19,]
name.of.web[17,2] <- 'pisces'
name.of.web[5,2] <- 'ephemeridae'
