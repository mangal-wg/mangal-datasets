...
folder_name <- "yodzis_1998" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB357")
...
ref <- list(doi       = "10.1046/j.1365-2656.1998.00224.x",
             jstor     = "NA",
             pmid      = "NA",
             paper_url = "https://doi.org/10.1046%2Fj.1365-2656.1998.00224.x",
             data_url  = "https://globalwebdb.com/",
             author    = "PETER YODZIS",
             year      = "1998",
             bibtex    = "@article{YODZIS_1998, doi = {10.1046/j.1365-2656.1998.00224.x}, url = {https://doi.org/10.1046%2Fj.1365-2656.1998.00224.x}, year = 1998, month = {jul}, publisher = {Wiley}, volume = {67}, number = {4}, pages = {635--658}, author = {PETER YODZIS}, title = {Local trophodynamics and the interaction of marine mammals and fisheries in the Benguela ecosystem}, journal = {Journal of Animal Ecology}}")
...
dataset <- list(name        = "yodzis_1998",
                 date        = "1998-01-01",
                 description = "Food web of the Benguela ecosystem",
                 public      = TRUE)
...
#   map(~mutate(.x, sp = str_replace_all(.x$sp, c("anchovy" = "Engraulis capensis", "pilchard" = "Sardinops ocellatus", "round herring" = "Dussumieriidae",
#                     "goby" = "Sufflogobius bibarbatus", "chub mackerel" = "Scomber japonicus", "whales and dolphins" = "Cetacea",
#                     "birds" = "Aves", "seals" = "Pinnipedia", "sharks" = "Selachii"))))
# 
