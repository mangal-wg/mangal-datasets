...
# 
# taxa_df[[1]]$`name_clear`[3] <- "Acartia tonsa, harpacticoids" # Manually editing some wrong name added by Global Names Recognition and Discovery.
# taxa_df[[1]]$`name_clear`[4] <- "Gammarus, Paleomonetes"
# taxa_df[[1]]$`name_clear`[9] <- "small Paralichthys"
# taxa_df[[1]]$`name_clear`[10] <- "small Leiostomus, Micropogon"
# taxa_df[[1]]$`name_clear`[13] <- "Roccus, Cynoscion"
