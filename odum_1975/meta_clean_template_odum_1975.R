...
folder_name <- "odum_1975" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB130") # Name of the dataset in Trophic metacommunities-master/Trophic_metacom_meta_analysis/Data
...
ref <- list(doi       = "NA",
            ...
            author    = "W. E. Odum",
            year      = "1975",
            bibtex    = "@inbook{odum_1975, title = {The detritus-based food web of an estuarine mangrove community} booktitle = {Chemistry, Biology and the Estuarine System}, series = {Estuarine Research}, volume = {1}, author = {W. E. Odum, E. J. Heald}, pages = {265-286, from p. 281}, year = {1975}, publisher = {Academic Press}}")
...
dataset <- list(name        = "odum_1975",
                date        = "1975-01-01",
                description = "Food Web of estuarine mangrove",
                public      = TRUE)
...
taxa_df[[1]]$name_clear[9] <- "Crustacea"
taxa_df[[1]]$name_clear[10] <- "Pisces"
taxa_df[[1]]$name_clear[12] <- "Gambusia affinis"
taxa_df[[1]]$name_clear[13] <- "Heterandria formosa"
taxa_df[[1]]$name_clear[14] <- "Decapoda"
taxa_df[[1]]$name_clear[15] <- "Caridea"
taxa_df[[1]]$name_clear[16] <- "Floridichthys carpio"
taxa_df[[1]]$name_clear[17] <- "Lophogobius cyprinoides"
taxa_df[[1]]$name_clear[18] <- "Pisces"
taxa_df[[1]]$name_clear[19] <- "Copepoda"
taxa_df[[1]]$name_clear[24] <- "Megalops"
taxa_df[[1]]$name_clear[25] <- "Sphyraena"
taxa_df[[1]]$name_clear[26] <- "Carcharhinus leucas"
taxa_df[[1]]$name_clear[27] <- "Pisces"
taxa_df[[1]]$name_clear[28] <- "Alligator mississippiensis"
taxa_df[[1]]$name_clear[29] <- "Haliaeetus leucocephalus"
taxa_df[[1]]$name_clear[32] <- "Mangrove leaves"
