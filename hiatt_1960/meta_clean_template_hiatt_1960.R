...
folder_name <- "hiatt_1960" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB17")
...
ref <- list(doi       = "10.2307/1942181",
             jstor     = "NA",
             pmid      = "NA",
             paper_url = "https://doi.org/10.2307%2F1942181",
             data_url  = "https://globalwebdb.com/",
             author    = "Robert W. Hiatt",
             year      = "1960",
             bibtex    = "@article{Hiatt_1960, doi = {10.2307/1942181}, url = {https://doi.org/10.2307%2F1942181}, year = 1960, month = {jan}, publisher = {Wiley}, volume = {30},number = {1}, pages = {65--127}, author = {Robert W. Hiatt and Donald W. Strasburg}, title = {Ecological Relationships of the Fish Fauna on Coral Reefs of the Marshall Islands}, journal = {Ecological Monographs}}")
...
dataset <- list(name        = "hiatt_1960",
                 date        = "1960-01-01",
                 description = "Food web of the Marshalles reefs",
                 public      = TRUE)
...
# 
# taxa_df[[1]]$name_clear[8] <- "Small midwater plankton feeders"
# taxa_df[[1]]$name_clear[3] <- "Balanus balanoides, B. eburneus"
# taxa_df[[1]]$name_clear[9] <- "Schizoporella, Hydroides, Haliplanella"
