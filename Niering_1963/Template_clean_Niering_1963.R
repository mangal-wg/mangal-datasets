...
refs <- list(doi       = "10.2307/1948559",
            jstor     = "https://www.jstor.org/stable/1948559",
            pmid      = "NA",
            paper_url = "https://esajournals.onlinelibrary.wiley.com/doi/pdf/10.2307/1948559",
            data_url  = "https://globalwebdb.com/",
            author    = "Niering",
            year      = "1963",
            bibtex    = "@article{Niering_1963,	doi = {10.2307/1948559}, url = {https://doi.org/10.2307%2F1948559}, year = 1963, month = {feb}, publisher = {Wiley}, volume = {33}, number = {2}, pages = {131--160}, author = {William A. Niering}, title = {Terrestrial Ecology of Kapingamarangi Atoll, Caroline Islands}, journal = {Ecological Monographs}}")
...
datasets <- list(name        = "Niering_1963",
                date        = "1954-06-22",
                description = "Food web structure of the Kapingamarangi atoll, Caroline Islands",
                public      = TRUE)
...
networks <- list(name             = "Niering_1963",
                date             = "1954-06-22",
                lat              = lat,
                lon              = lon,
                srid             = srid,
...
name.of.web[31,1] <- "fungi"
name.of.web[32,1] <- "snails"
name.of.web[33,1] <- "annelids"
name.of.web <- name.of.web[!duplicated(name.of.web$original_name), ]
name.of.web[4,2] <- "Invertebrata"
name.of.web[11,2] <- "Plantae"
...
matrice.interaction <- mutate(matrice.interaction, type = ifelse(sp_taxon_1 == 'algae' | sp_taxon_1 == 'land vegetation' | 
                                                                 sp_taxon_1 == 'Cyrtosperma' | sp_taxon_1 == 'Pandanus' | 
                                                                 sp_taxon_1 == 'breadfruit' | sp_taxon_1 == 'coconut' | sp_taxon_1 == 'phytoplankton', 'herbivory', 'predation'))
matrice.interaction[c(13,16,18,19),4] <- 'unknown'
...
taxa_back_df[6,4] <- "182570"
taxa_back_df[11,4] <- "564528"
taxa_back_df[14,4] <- "174822"
#------------------------------
# Set traits table
#------------------------------
