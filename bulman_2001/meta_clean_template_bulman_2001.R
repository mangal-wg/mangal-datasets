...
folder_name <- "bulman_2001" # Name of the subfolder in mangal-datasets
food_web_name <- c("WEB339")
...
ref <- list(doi       = "10.1016/j.marenvres.2006.03.003",
             jstor     = "NA",
             pmid      = "NA",
             paper_url = "https://doi.org/10.1016%2Fj.marenvres.2006.03.003",
             data_url  = "https://globalwebdb.com/",
             author    = "Hsing-Juh Lin",
             year      = "2006",
             bibtex    = "@article{Lin_2006, doi = {10.1016/j.marenvres.2006.03.003}, url = {https://doi.org/10.1016%2Fj.marenvres.2006.03.003}, year = 2006, month = {jul}, publisher = {Elsevier {BV}}, volume = {62}, number = {1}, pages = {61--82}, author = {Hsing-Juh Lin and Xiao-Xun Dai and Kwang-Tsao Shao and Huei-Meei Su and Wen-Tseng Lo and Hwey-Lian Hsieh and Lee-Shing Fang and Jia-Jang Hung}, title = {Trophic structure and functioning in a eutrophic and poorly flushed lagoon in southwestern Taiwan}, journal = {Marine Environmental Research}}")
...
dataset <- list(name        = "lin_2006",
                 date        = "2006-01-01",
                 description = "Dietary matrix of the Tapong Bay",
                 public      = TRUE)
...
FW_name <- data_matrice %>%
  ...
  map(~mutate(.x, type = ifelse(str_detect(.x$sp_taxon_2, "(.*[Dd]ebris.*)|(.*[Dd]etritu*.(?!.*fish.*))"), "commensalism", .x$type))) %>%
...
#   unname() %>%
#   unique() %>%
#   str_replace_all(c("Oysters" = "Ostreidae", "Polychaetes" = "Polychaeta", "Gastropods" = "Gastropoda",
#                     "Bivalves" = "Bivalvia", "Barnacles" = "Thoracica", "Amphipods" = "Amphipoda", "Crabs" = "Brachyura", "Shrimps" = "Decapoda"))
# 
