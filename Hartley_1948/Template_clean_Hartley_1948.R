...
lat  <- 52.12020560917414
lon  <- 0.01959270300017124
srid <- 4326
...
refs <- list(doi       = "10.2307/1604",
            jstor     = "https://www.jstor.org/stable/1604",
            pmid      = "NA",
            paper_url = "https://www.jstor.org/stable/pdf/1604.pdf?refreqid=excelsior%3Ac1a6f86128504dffbc1bffdc65485b16",
            data_url  = "https://globalwebdb.com/",
            author    = "Hartley",
            year      = "1948",
            bibtex    = "@article{Hartley_1948,	doi = {10.2307/1604}, url = {https://doi.org/10.2307%2F1604}, year = 1948, month = {may}, publisher = {{JSTOR}}, volume = {17}, number = {1}, pages = {1}, author = {P. H. T. Hartley}, title = {Food and Feeding Relationships in a Community of Fresh-Water Fishes}, journal = {The Journal of Animal Ecology}}")
...
datasets <- list(name        = "Hartley_1948",
                date        = "1939-01-01",
                description = "Food web structure of a fresh-water fishes community in the River Cam, Barrington, United Kingdom",
                public      = TRUE)
...
networks <- list(name             = "Hartley_1948",
                date             = "1939-01-01",
                lat              = lat,
                lon              = lon,
                srid             = srid,
...
name.of.web[5,1] <- "Simulium larvae (black fly)"
name.of.web <- name.of.web[-c(6),]
name.of.web[c(1,4),2] <- c("Plantae", "Diatoms")
...
matrice.interaction <- mutate(matrice.interaction, type = ifelse(sp_taxon_1 == 'Plant fragments' | sp_taxon_1 == "Other diatoms" | 
                                                                 sp_taxon_1 == "Synedra" | sp_taxon_1 == "Coscinodiscus" | sp_taxon_1 == "Spirogyra", 'herbivory', 'predation'))
