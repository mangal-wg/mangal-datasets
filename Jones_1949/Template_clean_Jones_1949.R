...
name.of.web <- mutate(name.of.web, scientific_name = ifelse(original_name == 'leaf fragments', 'Plantae', scientific_name))
name.of.web <- mutate(name.of.web, scientific_name = ifelse(original_name == 'diatoms (unspec.)', 'Diatoms', scientific_name))
name.of.web <- mutate(name.of.web, scientific_name = ifelse(original_name == 'other green algae (unspec.)', 'Algae', scientific_name))
...
matrice.interaction <- mutate(matrice.interaction, type = ifelse(sp_taxon_1 == 'Ulothrix sp.' | sp_taxon_1 == 'leaf fragments' |
                                                                 sp_taxon_1 == 'diatoms (unspec.)' | sp_taxon_1 == 'other green algae (unspec.)' |
                                                                 sp_taxon_1 == 'Cladophora sp.' | sp_taxon_1 == 'Microspora sp.', 'herbivory', 'predation'))
...
taxa_back_df[13,4] <- "115495"
taxa_back_df[15,5] <- "163316"
taxa_back_df[21,4] <- "604457"
