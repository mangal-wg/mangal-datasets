...
# 
# # Open file
# kaehler_et_al_2005 <- read.csv2(file = "importation_mangal/kaehler_et_al_2005/raw/kaehler_et_al_2005.csv", header = FALSE, stringsAsFactors = FALSE, na.strings = "")
# 
# # Cleaning for melt()
...
# #------------------------------
# 
# # traits_df <- read.csv2(file = "importation_mangal/kaehler_et_al_2005/data/kaehler_et_al_2005_traits.csv", header = TRUE)
# 
...
# #------------------------------
# 
# write.csv2(x = taxo_back_df, file = "importation_mangal/kaehler_et_al_2005/data/kaehler_et_al_2005_taxo_back.csv", row.names = FALSE)
# write.csv2(x = taxons_df, file = "importation_mangal/kaehler_et_al_2005/data/kaehler_et_al_2005_taxons.csv", row.names = FALSE)
# write.csv2(x = kaehler_et_al_2005, file = "importation_mangal/kaehler_et_al_2005/data/kaehler_et_al_2005_inter.csv", row.names = FALSE)
# # write.csv2(x = traits_df, file = "importation_mangal/kaehler_et_al_2005/data/kaehler_et_al_2005_traits.csv", row.names = FALSE)

taxo_back_df <- read.csv2("importation_mangal/kaehler_et_al_2005/data/kaehler_et_al_2005_taxo_back.csv", header = TRUE)
taxons_df <- read.csv2("importation_mangal/kaehler_et_al_2005/data/kaehler_et_al_2005_taxons.csv", header = TRUE)
kaehler_et_al_2005 <- read.csv2("importation_mangal/kaehler_et_al_2005/data/kaehler_et_al_2005_inter.csv", header = TRUE)
# traits_df <- read.csv2("importation_mangal/kaehler_et_al_2005/data/kaehler_et_al_2005_traits.csv", header = TRUE)
